...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Create R package in Autonomy",
    Description = "Autonomy session with ThinkR",
    `Authors@R` = c(
      person("Aurelie", "Kamoun", email = "aurelie.kamoun@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-8403-1944")),
      person(given = "FIND", role = "cph")
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("FIND")
```
